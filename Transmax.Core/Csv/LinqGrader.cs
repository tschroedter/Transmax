...
namespace Transmax.Core.Csv
{
        ...
        : IGrader
    {
        ...
        [NotNull] private readonly IInputFile m_Input;

        [NotNull] private readonly IOutputFile m_Output;
        ...
        {
            get { return m_Input.Filename; }
            set { m_Input.Filename = value; }
        }

        public string DestinationFilename
        {
            get { return m_Output.Filename; }
            set { m_Output.Filename = value; }
        }
        ...
        private void Grade()
        {
            ...
            var lines = input.Select(x => x.Surname + ", " + x.FirstName + ", " + x.Score);
